...
def listar_sessoes(current_user, current_role):
    ...
    return jsonify([{'id': s.id, 'jogador_id': s.jogador_id, 'cenario_id': s.cenario_id, 'tempo_total': s.tempo_total, 'modo_jogo': s.modo_jogo, 'coop': s.coop, 'rota_id': s.rota_id} for s in sessoes]), 200
